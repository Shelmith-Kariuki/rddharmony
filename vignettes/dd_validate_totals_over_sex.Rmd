...
To show how `dd_validate_totals_over_sex` works, we will be using the `validate_totals_over_sex` dataset that is part of this package. This dataset contains death counts of Kuwait for the year 2009, obtained from the Demographic Yearbook. 
