...
There are two functions involved. `DDharmonize_Vitals5` is implemented on births and deaths data while `DDharmonize_Pop5` is implemented on population data.
